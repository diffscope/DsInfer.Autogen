...
public class StringMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          dsinfer_csharp_bindingsPINVOKE.delete_StringMap(swigCPtr);
        }
  ...
  public StringMap() : this(dsinfer_csharp_bindingsPINVOKE.new_StringMap__SWIG_0(), true) {
  }

  public StringMap(StringMap other) : this(dsinfer_csharp_bindingsPINVOKE.new_StringMap__SWIG_1(StringMap.getCPtr(other)), true) {
  ...
  private uint size() {
    uint ret = dsinfer_csharp_bindingsPINVOKE.StringMap_size(swigCPtr);
    return ret;
  }

  private bool empty() {
    bool ret = dsinfer_csharp_bindingsPINVOKE.StringMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    dsinfer_csharp_bindingsPINVOKE.StringMap_Clear(swigCPtr);
  }

  private string getitem(string key) {
    string ret = dsinfer_csharp_bindingsPINVOKE.StringMap_getitem(swigCPtr, key);
    if (dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Pending) throw dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, string x) {
    dsinfer_csharp_bindingsPINVOKE.StringMap_setitem(swigCPtr, key, x);
    if (dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Pending) throw dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = dsinfer_csharp_bindingsPINVOKE.StringMap_ContainsKey(swigCPtr, key);
    if (dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Pending) throw dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, string value) {
    dsinfer_csharp_bindingsPINVOKE.StringMap_Add(swigCPtr, key, value);
    if (dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Pending) throw dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = dsinfer_csharp_bindingsPINVOKE.StringMap_Remove(swigCPtr, key);
    if (dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Pending) throw dsinfer_csharp_bindingsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = dsinfer_csharp_bindingsPINVOKE.StringMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = dsinfer_csharp_bindingsPINVOKE.StringMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    dsinfer_csharp_bindingsPINVOKE.StringMap_destroy_iterator(swigCPtr, swigiterator);
  }
